...
$(document).ready(function() {
  ...
  // ***************************************************************************
  // test the regular expression used in sortKeys.numeric
  // .replace(/^[^\d.]*/, 'x')  means something like  <<replace any sequence of non-digits with x>>
  // For more details: https://developer.mozilla.org/en/docs/Web/JavaScript/Guide/Regular_Expressions
  console.log( 'bla bla $44.99'.replace(/^[^\d.]*/, 'x') );
  // ***************************************************************************
